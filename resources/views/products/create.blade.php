<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-3xl font-extrabold text-slate-800 tracking-tight">Tambah Barang</h2>
                <p class="text-sm text-slate-500 mt-1">Masukkan data barang baru</p>
            </div>
        </div>
    </x-slot>
        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" name="name" id="name" class="block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors @error('name') border-red-500 @enderror" value="{{ old('name') }}" placeholder="Contoh: Chiki Balls Rasa Coklat" required>
                ...
                <div>
                    ...
                    <input type="text" name="unit" id="unit" class="block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors @error('unit') border-red-500 @enderror" value="{{ old('unit', 'Pcs') }}" placeholder="Pcs, Dus, Bungkus..." required>
                ...
                <div>
                    ...
                    <input type="number" name="buy_price" id="buy_price" class="block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors @error('buy_price') border-red-500 @enderror" value="{{ old('buy_price', 0) }}" min="0" required>
                ...
                <div>
                    ...
                    <input type="number" name="sell_price" id="sell_price" class="block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors @error('sell_price') border-red-500 @enderror" value="{{ old('sell_price', 0) }}" min="0" required>
                ...
                <div>
                    ...
                    <input type="number" name="stock" id="stock" class="block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors @error('stock') border-red-500 @enderror" value="{{ old('stock', 0) }}" min="0" required>
                ...
                <div>
                    ...
                    <input type="number" name="min_stock" id="min_stock" class="block w-full px-4 py-3 border border-slate-200 rounded-xl bg-slate-50/50 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors @error('min_stock') border-red-500 @enderror" value="{{ old('min_stock', 5) }}" min="0" required>
                    <p class="mt-1 text-xs text-slate-400">Sistem akan memberi peringatan jika stok kurang dari batas ini.</p>
